...
function severityTone(severity) {
  if (severity === "critical")
    return { badge: "expense", text: "text-expense", bg: "bg-expense-bg" };
  if (severity === "high" || severity === "warning")
    return { badge: "warning", text: "text-warning", bg: "bg-warning/10" };
...
export default function SmartInsightsCard({ profileId }) {
  ...
  const mapInsightsError = useCallback(
    (err) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p
              ...
              data-testid="smart-insights-error-diagnostics"
            >
  ...
  return (
    <Card className="p-5" data-testid="smart-insights-card">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            {summary.isOverspendingAlert && (
              <div
                className="mt-2 inline-flex items-center gap-2 rounded-full px-3 py-1 bg-expense-bg text-expense text-xs font-semibold"
                data-testid="smart-insights-overspending-delta"
              >
                Overspending
            ...
            {summary.isCategoryTrend && (
              <div
                className="mt-2 inline-flex items-center gap-2 rounded-full px-3 py-1 bg-brand-primary/10 text-brand-primary text-xs font-semibold"
                data-testid="smart-insights-category-trend-delta"
              >
        ...
        <Badge variant={tone.badge} data-testid="smart-insights-severity-badge">
          {summary.severity}
        </Badge>
      </div>
    </Card>
