...
export function Button({
  ...
  const variants = {
    primary:
      "bg-brand-primary text-white hover:bg-brand-hover focus:ring-brand-primary/50 shadow-sm hover:shadow-md",
    secondary:
      "bg-surface text-text-primary border border-border-color hover:bg-surface-hover focus:ring-brand-primary/30",
  ...
  return (
    <div
      className={cn(
        ...
        hover &&
          "hover:shadow-md hover:border-[#D1CCC2] transition-all duration-200 hover:-translate-y-0.5",
        className,
      )}
      {...props}
    >
