...
export default function BudgetsScreen() {
  ...
  const handleDeleteTotalBudget = () => {
    ...
    Alert.alert(
      "Delete Total Budget",
      "Are you sure you want to delete the total monthly budget?",
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Delete",
          ...
          onPress: async () => {
            try {
              ...
              setBudgetProgress((current: any) =>
                removeBudgetFromProgress(current, totalBudget.budget_id),
              );
              await loadBudgets();
            } catch {
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {totalBudget ? (
            ...
            >
              <View style={styles.totalHeader}>
                ...
                <Text
                  style={[
                    styles.totalPct,
                    { color: totalBudget.is_over_budget ? colors.expense : colors.primary },
                  ]}
                >
              ...
              <View style={styles.totalFooter}>
                ...
                >
                  {totalBudget.is_over_budget ? "Over by" : "Remaining"}: $
            ...
            <TouchableOpacity
              ...
              onPress={openCreateTotalBudgetModal}
            >
          ...
          {categoryBudgets.length > 0 ? (
                ...
                >
                  <View style={styles.categoryHeader}>
                    ...
                    <Text
                      style={[
                        styles.categoryPct,
                        { color: budget.is_over_budget ? colors.expense : colors.primary },
                      ]}
                    >
            ...
            <Text style={[styles.hint, { color: colors.textSecondary }]}>
              No category budgets yet. Tap + to add one.
            </Text>
          )}
