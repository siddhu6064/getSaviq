    ...
    <TouchableOpacity style={styles.container} onPress={onPress} activeOpacity={0.7}>
      <View
        style={[
          ...
          {
            backgroundColor: category?.color ? category.color + "20" : lightTheme.colors.background,
          },
        ]}
      >
        <Ionicons
          name={
            isTransfer
              ? "swap-horizontal"
              : (category?.icon as keyof typeof Ionicons.glyphMap) || "receipt"
          }
          size={20}
      ...
      <View style={styles.content}>
        ...
        <View style={styles.bottomRow}>
          <View style={styles.metaContainer}>
            ...
            {expense.merchant && <Text style={styles.merchant}>· {expense.merchant}</Text>}
          </View>
